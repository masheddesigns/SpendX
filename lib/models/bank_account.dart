...
class BankAccount {
  ...
  final String accountType; // 'savings' | 'current' | 'fd' | 'wallet' | 'ppf' | 'stock'
  ...
  static String iconForType(String type) {
    switch (type) {
      case 'savings': return 'account_balance';
      case 'current': return 'account_balance_wallet';
      case 'fd': return 'lock';
      case 'cash': return 'payments';
      case 'wallet': return 'wallet';
      case 'ppf': return 'savings';
      case 'stock': return 'trending_up';
      case 'mutual_fund': return 'pie_chart';
  ...
  static String colorForType(String type) {
    switch (type) {
      ...
      case 'ppf': return '#06B6D4';
      case 'stock': return '#EF4444';
      case 'mutual_fund': return '#EC4899';
  ...
  BankAccount copyWith({double? balance, String? name}) => BankAccount(
        id: id,
        userId: userId,
        name: name ?? this.name,
        bank: bank,
