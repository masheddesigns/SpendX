          ...
          return ListView(
            ...
            children: [
              ...
              _ModuleToggle(
                ...
                subtitle: 'Track fuel logs, mileage, and vehicle expenses.',
                value: settings.enableVehicles,
                onChanged: settings.setEnableVehicles,
              ),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: Theme.of(context).colorScheme.surfaceContainer,
        borderRadius: BorderRadius.circular(16),
        border: Border.all(color: value ? color.withValues(alpha: 0.5) : Theme.of(context).colorScheme.outlineVariant.withValues(alpha: 0.3)),
      ),
      child: SwitchListTile(
        ...
        secondary: Container(
          ...
          height: 44,
          decoration: BoxDecoration(
            color: value ? color.withValues(alpha: 0.15) : Theme.of(context).colorScheme.surfaceContainerHighest,
            borderRadius: BorderRadius.circular(12),
          ),
          child: Icon(icon, color: value ? color : Theme.of(context).colorScheme.onSurfaceVariant, size: 22),
        ),
        title: Text(title, style: TextStyle(fontWeight: value ? FontWeight.w600 : FontWeight.normal, color: value ? Theme.of(context).colorScheme.onSurface : Theme.of(context).colorScheme.onSurfaceVariant)),
        subtitle: Text(subtitle, style: TextStyle(color: Theme.of(context).colorScheme.onSurfaceVariant.withValues(alpha: 0.8), fontSize: 12)),
        value: value,
        onChanged: onChanged,
      ),
    );
